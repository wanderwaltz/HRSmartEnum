...
+ (TyphoonDefinition *) withClass: (Class) clazz
                       factoryKey: (NSString *) factoryKey
                   initialization: (void (^)(TyphoonInitializer*))initialization
{
                       ...
                       properties: (void (^)(TyphoonDefinition  *)) properties
{
    ...
    TyphoonDefinition *definition = [[TyphoonDefinition alloc] initWithClass: clazz
                                                                         key: key
                                                            factoryComponent: factoryKey];
    if (initialization)
    {
