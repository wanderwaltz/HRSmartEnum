...
- (CGSize) convertToCGSize: (NSString *) stringValue
{
    return CGSizeFromString(stringValue);
}


- (CGPoint) convertToCGPoint: (NSString *) stringValue
{
    return CGPointFromString(stringValue);
}


- (CGRect) convertToCGRect: (NSString *) stringValue
{
    return CGRectFromString(stringValue);
}
        ...
        requiredType:(TyphoonTypeDescriptor*)requiredType
{
    ...
    else if (requiredType.primitiveType == TyphoonPrimitiveTypeCGRect)
    {
        CGRect converted = [self convertToCGRect: textValue];
        [invocation setArgument: &converted atIndex: index];
    }
    else if (requiredType.primitiveType == TyphoonPrimitiveTypeCGSize)
    {
        CGSize converted = [self convertToCGSize:textValue];
        [invocation setArgument:&converted atIndex: index];
    }
    else if (requiredType.primitiveType == TyphoonPrimitiveTypeCGPoint)
    {
        CGPoint converted = [self convertToCGPoint:textValue];
        [invocation setArgument:&converted atIndex: index];
    }
